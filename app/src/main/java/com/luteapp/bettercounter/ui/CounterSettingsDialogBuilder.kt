...
import com.luteapp.bettercounter.IntervalAdapter
import com.luteapp.bettercounter.R
import com.luteapp.bettercounter.ViewModel
import com.luteapp.bettercounter.databinding.EditCounterBinding
import com.luteapp.bettercounter.persistence.DEFAULT_INTERVAL
...
class CounterSettingsDialogBuilder(private val context : Context, private val viewModel : ViewModel) {
    ...
    private val colorAdapter = com.luteapp.bettercounter.ColorAdapter(context)
